...
class RichDecoratedBox extends StatelessWidget {
  const RichDecoratedBox({
    super.key,
    ...
    return const Text.rich(
      TextSpan(
        ...
        children: [
          ...
          TextSpan(
            text: 'Add rich text effects within typing animation using '
                '`TypeThisMatcher` that works with regex pattern.',
          ),
        ],
      ),
    );
